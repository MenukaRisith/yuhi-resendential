const ServicesSection = () => {
  return (
    <section className="w-full bg-white py-12 sm:py-16 flex flex-col items-center" id="services">
      {/* Section Title */}
        ...
        {[
          {
            ...
            description:
              "Lorem ipsum odor amet, consectetuer adipiscing elit. Pretium diam ante sem phasellus.",
          ...
          <div
            key={index}
            className="bg-white rounded-2xl overflow-hidden flex flex-col transition-shadow duration-300 delay-200 hover:shadow-md group"
          >
            {/* Image at the top */}
            ...
            <div className="p-6 sm:p-8">
              ...
              <button
                className="w-full sm:w-36 h-10 pl-3 pr-5 py-2.5 bg-[#0D2220] rounded-md flex justify-center items-center gap-1.5 transition-all duration-200 hover:bg-[#00c851]"
              >
                <svg

...
const HeroSection = () => {
  return (
    <section className="w-full bg-white flex flex-col items-center pt-20 pb-16 sm:pt-28 sm:pb-24 lg:pt-36 lg:pb-40">
      {/* Heading Section */}
      <div className="text-center mb-8 px-4 sm:px-8">
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold font-['Inter'] leading-tight text-gray-900">
          We are the <span className="text-green-600">#1</span> Renovation
          <br /> Agency in Dubai, UAE
        </h1>
        <p className="mt-4 text-lg sm:text-xl font-medium text-gray-600 font-['Poppins'] leading-snug max-w-xl mx-auto">
      ...
      <div className="flex flex-wrap justify-center items-center bg-stone-50 rounded-3xl border py-7 px-6 sm:px-12 lg:px-14 gap-8 sm:gap-14 mb-12">
        <div className="flex flex-col items-center sm:items-start">
          <div className="text-4xl sm:text-5xl lg:text-6xl font-bold font-['Inter'] leading-tight">
            <span className="text-gray-900"><AnimatedNumber value={200} /></span>
        ...
        <div className="flex flex-col items-center sm:items-start">
          <div className="text-4xl sm:text-5xl lg:text-6xl font-bold font-['Inter'] leading-tight">
            <span className="text-gray-900"><AnimatedNumber value={100} /></span>
            <span className="text-green-600">%</span>
          </div>
        ...
        <div className="flex flex-col items-center sm:items-start">
          <div className="text-4xl sm:text-5xl lg:text-6xl font-bold font-['Inter'] leading-tight">
            <span className="text-gray-900"><AnimatedNumber value={120} /></span>
            <span className="text-green-600">+</span>
          </div>
        ...
        <div className="flex flex-col items-center sm:items-start">
          <div className="text-4xl sm:text-5xl lg:text-6xl font-bold font-['Inter'] leading-tight">
            <span className="text-gray-900"><AnimatedNumber value={85} /></span>
            <span className="text-green-600">+</span>
          </div>
      ...
      <a
        href="#proposal"
        className="h-12 sm:h-14 lg:h-16 pl-4 sm:pl-5 pr-6 sm:pr-7 py-2 sm:py-3.5 bg-gray-900 text-white text-lg sm:text-xl font-medium font-['Poppins'] rounded-lg flex justify-center items-center gap-2 transition-all duration-200 hover:bg-gray-700"
      >

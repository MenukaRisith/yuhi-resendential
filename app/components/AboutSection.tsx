  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-5xl text-center mb-12 sm:mb-16 md:mb-20 px-4 sm:px-8 md:px-12">
        ...
        <p className="mt-4 sm:mt-6 md:mt-8 text-base sm:text-lg md:text-xl lg:text-2xl font-normal font-['Poppins'] text-[#DDDDD] leading-relaxed">
          Lorem ipsum odor amet, consectetuer adipiscing elit. Augue tincidunt libero cras primis sodales nisl.
        </p>
      </div>
    </section>
  );
